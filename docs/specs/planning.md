...
## Version v0.1.2 — 0 BL (gap)
**Jalon de sortie :** PR avec CI verte mergée via `forge approve` ; run tué puis repris sans incohérence.

Exigences CDC (safe_mode, `forge approve`, reprise kill -9) **sans BL dédiés** — voir `gaps` dans `planning.json`.

## Version v0.1.3 — 1 BL · L0 · 1 worker
**Jalon de sortie :** Rapport de run complet avec statistiques et ADR générés.

| Vague | BL parallélisables | Tailles |
|---|---|---|
| 1 | BL-forge-047 — Statistiques de consommation | S |

## Version v0.2.0 — 12 BL · L0 · 1 worker
...
| 3 | **BL-forge-021** — Boucle de correction par Issue<br>BL-forge-023 — Cloisonnement mono-provider | L, M |
| 4 | BL-forge-022 — Plafond d'itérations<br>BL-forge-025 — Bascule de provider | S, M |

**Chemin critique** (poids 10) : BL-forge-016 → BL-forge-018 → BL-forge-021 → BL-forge-025

## Version v0.3.0 — 4 BL · L1 · 3 workers
...
| 2 | BL-forge-038 — Rebase post-merge<br>BL-forge-039 — Plafond de concurrence par provider | M, S |

**Chemin critique** (poids 6) : BL-forge-036 → BL-forge-037 → BL-forge-039

## Version v0.4.0 — 7 BL · L2 · 3 workers
...
|---|---|---|
| Parallélisme multi-workers | v0.3.0 | BL-036..039 |
| Self-hosting | v0.2.0+ | Amorçage humain A10 ; mode nominal post-v0.2 |
| L2 autonome (`forge approve` sans relance) | v0.4.0+ | EXG-TRU-02 |
| Rollback version / repair-state | v0.4.0 | Aucun BL — gap |
| Multi-repo automatique | v0.4.0 | BL-040..045 |
